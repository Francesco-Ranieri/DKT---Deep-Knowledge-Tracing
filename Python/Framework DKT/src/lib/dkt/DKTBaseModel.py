...
class DKTBaseModel:
    ...
    def pad_sequences(self, sequences, maxlen=None, dim=1, dtype='int32', padding='pre',
    ...
    def run_function(self, seqs, num_skills, batch_size, time_window, start_from, end_before):
        x = []
        y = []
        ...
        Y = self.pad_sequences(y, padding='post', maxlen=maxlen, dim=num_skills + 1, value=0.0)
